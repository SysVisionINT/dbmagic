...
public class XMLReader extends Container {
	...
	public void execute() throws BuildException {
		try {
			setModel(XMLModelReader.read(file));
			StdOut.println("Model loaded from file " + file);
			getModel().validate();
			StdOut.println("Model validated");
		} catch (Exception e) {
			e.printStackTrace();
			throw new BuildException("Unable to read XML file " + file, e);
		}
